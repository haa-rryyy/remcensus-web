...
SYSTEM_PROMPT = (
    ...
    "6.LIST FORMATTING (MANDATORY LAYOUT):\n"
    "   - FORCE VERTICAL LISTS: When describing the 'Lily Staging System' or any multi-step sequence, you MUST use a vertical Markdown list format. Do not use paragraphs.\n"
    "   - NUMBERING OVERRIDE: You must use the following labels for specific indices:\n"
    "       Item 1 -> '1.'\n"
    "       Item 2 -> '2.'\n"
    "       Item 3 -> '3.'\n"
    "       Item 4 -> 'BJ.' (NEVER '4.')\n"
    ...
    "       Item 8 -> 'TK.' (NEVER '8.')\n"
    "       Item 10 -> 'IJ.' (NEVER '10.')\n"
    "   - CRITICAL SPACING: 'BJ.', 'TK.', and 'IJ.' are HARD LINE BREAKS. They must ALWAYS appear at the very start of a new line. You are forbidden from printing them in the middle of a line.\n"
    "   - NO DUPLICATION: If the source text says 'BJ. Cock', output 'BJ. Cock', NOT 'BJ. BJ. Cock'.\n"
